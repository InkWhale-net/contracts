...
import { ContractAbi } from '../contract-info/my_azero_staking';
import QueryMethods from '../query/my_azero_staking';
import BuildExtrinsicMethods from '../build-extrinsic/my_azero_staking';
import TxSignAndSendMethods from '../tx-sign-and-send/my_azero_staking';
import MixedMethods from '../mixed-methods/my_azero_staking';
import EventsClass from '../events/my_azero_staking';
