...
import { ContractAbi } from '../contract-info/token_standard';
import QueryMethods from '../query/token_standard';
import BuildExtrinsicMethods from '../build-extrinsic/token_standard';
import TxSignAndSendMethods from '../tx-sign-and-send/token_standard';
import MixedMethods from '../mixed-methods/token_standard';
import EventsClass from '../events/token_standard';
