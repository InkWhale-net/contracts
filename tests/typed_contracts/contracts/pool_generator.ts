...
import { ContractAbi } from '../contract-info/pool_generator';
import QueryMethods from '../query/pool_generator';
import BuildExtrinsicMethods from '../build-extrinsic/pool_generator';
import TxSignAndSendMethods from '../tx-sign-and-send/pool_generator';
import MixedMethods from '../mixed-methods/pool_generator';
import EventsClass from '../events/pool_generator';
