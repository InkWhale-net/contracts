...
import { ContractAbi } from '../contract-info/my_pool';
import QueryMethods from '../query/my_pool';
import BuildExtrinsicMethods from '../build-extrinsic/my_pool';
import TxSignAndSendMethods from '../tx-sign-and-send/my_pool';
import MixedMethods from '../mixed-methods/my_pool';
import EventsClass from '../events/my_pool';
