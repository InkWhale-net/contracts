...
import { ContractAbi } from '../contract-info/my_nft_pool';
import QueryMethods from '../query/my_nft_pool';
import BuildExtrinsicMethods from '../build-extrinsic/my_nft_pool';
import TxSignAndSendMethods from '../tx-sign-and-send/my_nft_pool';
import MixedMethods from '../mixed-methods/my_nft_pool';
import EventsClass from '../events/my_nft_pool';
