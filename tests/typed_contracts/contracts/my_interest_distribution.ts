...
import { ContractAbi } from '../contract-info/my_interest_distribution';
import QueryMethods from '../query/my_interest_distribution';
import BuildExtrinsicMethods from '../build-extrinsic/my_interest_distribution';
import TxSignAndSendMethods from '../tx-sign-and-send/my_interest_distribution';
import MixedMethods from '../mixed-methods/my_interest_distribution';
import EventsClass from '../events/my_interest_distribution';
