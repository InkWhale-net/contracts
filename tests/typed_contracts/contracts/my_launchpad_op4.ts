...
import { ContractAbi } from '../contract-info/my_launchpad_op4';
import QueryMethods from '../query/my_launchpad_op4';
import BuildExtrinsicMethods from '../build-extrinsic/my_launchpad_op4';
import TxSignAndSendMethods from '../tx-sign-and-send/my_launchpad_op4';
import MixedMethods from '../mixed-methods/my_launchpad_op4';
import EventsClass from '../events/my_launchpad_op4';
