...
import { ContractAbi } from '../contract-info/my_launchpad';
import QueryMethods from '../query/my_launchpad';
import BuildExtrinsicMethods from '../build-extrinsic/my_launchpad';
import TxSignAndSendMethods from '../tx-sign-and-send/my_launchpad';
import MixedMethods from '../mixed-methods/my_launchpad';
import EventsClass from '../events/my_launchpad';
