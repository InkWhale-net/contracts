...
import { ContractAbi } from '../contract-info/launchpad_generator';
import QueryMethods from '../query/launchpad_generator';
import BuildExtrinsicMethods from '../build-extrinsic/launchpad_generator';
import TxSignAndSendMethods from '../tx-sign-and-send/launchpad_generator';
import MixedMethods from '../mixed-methods/launchpad_generator';
import EventsClass from '../events/launchpad_generator';
