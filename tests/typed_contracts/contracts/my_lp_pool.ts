...
import ABI from '../../artifacts/my_lp_pool.json';
import QueryMethods from '../query/my_lp_pool';
import BuildExtrinsicMethods from '../build-extrinsic/my_lp_pool';
import TxSignAndSendMethods from '../tx-sign-and-send/my_lp_pool';
import MixedMethods from '../mixed-methods/my_lp_pool';
import EventsClass from '../events/my_lp_pool';
