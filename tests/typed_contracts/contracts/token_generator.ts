...
import { ContractAbi } from '../contract-info/token_generator';
import QueryMethods from '../query/token_generator';
import BuildExtrinsicMethods from '../build-extrinsic/token_generator';
import TxSignAndSendMethods from '../tx-sign-and-send/token_generator';
import MixedMethods from '../mixed-methods/token_generator';
import EventsClass from '../events/token_generator';
