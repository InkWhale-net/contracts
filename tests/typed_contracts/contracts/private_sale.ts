...
import { ContractAbi } from '../contract-info/private_sale';
import QueryMethods from '../query/private_sale';
import BuildExtrinsicMethods from '../build-extrinsic/private_sale';
import TxSignAndSendMethods from '../tx-sign-and-send/private_sale';
import MixedMethods from '../mixed-methods/private_sale';
import EventsClass from '../events/private_sale';
