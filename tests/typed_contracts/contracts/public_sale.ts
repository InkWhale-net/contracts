...
import { ContractAbi } from '../contract-info/public_sale';
import QueryMethods from '../query/public_sale';
import BuildExtrinsicMethods from '../build-extrinsic/public_sale';
import TxSignAndSendMethods from '../tx-sign-and-send/public_sale';
import MixedMethods from '../mixed-methods/public_sale';
import EventsClass from '../events/public_sale';
