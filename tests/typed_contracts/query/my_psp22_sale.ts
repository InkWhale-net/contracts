...
export default class Methods {
	...
	*/
	"approve" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::approve", [spender, value], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
	...
	*/
	"decreaseAllowance" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::decreaseAllowance", [spender, deltaValue], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
	...
	*/
	"transfer" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::transfer", [to, value, data], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
	...
	*/
	"increaseAllowance" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::increaseAllowance", [spender, deltaValue], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
	...
	*/
	"transferFrom" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::transferFrom", [from, to, value, data], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
	...
	*/
	"renounceOwnership" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "ownable::renounceOwnership", [], __options , (result) => { return handleReturnType(result, getTypeDescription(18, 'my_psp22_sale')); });
	}
	...
	*/
	"transferOwnership" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "ownable::transferOwnership", [newOwner], __options , (result) => { return handleReturnType(result, getTypeDescription(18, 'my_psp22_sale')); });
	}
	...
	*/
	"burn" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22Burnable::burn", [account, amount], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
	...
	*/
	"ownerMint" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "tokenMintCapTrait::ownerMint", [mintTo, amount], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
	...
	*/
	"setCap" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "tokenMintCapTrait::setCap", [cap], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
	...
	*/
	"setMintingFee" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "tokenMintCapTrait::setMintingFee", [mintingFee], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
	...
	*/
	"publicMint" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "tokenMintCapTrait::publicMint", [amount], __options , (result) => { return handleReturnType(result, getTypeDescription(14, 'my_psp22_sale')); });
	}
