...
import { ContractFile } from '../contract-info/my_interest_distribution';
	...
	*/
   	async "new" (
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, azeroStakingContract, masterAccount, totalRate, interestAccountRate);
			let response;
