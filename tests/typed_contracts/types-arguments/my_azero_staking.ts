...
export type StakeInformation = {
	stakingAmount: (string | number | BN),
	unclaimedAzeroReward: (string | number | BN),
	claimedAzeroReward: (string | number | BN),
	unclaimedInwReward: (string | number | BN),
	claimedInwReward: (string | number | BN),
	lastUpdated: (number | string | BN),
	lastUnclaimedAzeroReward: (string | number | BN),
	lastUnclaimedInwReward: (string | number | BN),
	lastAnchored: (number | string | BN),
	lastRewardsClaimed: (number | string | BN)
}

export type UnclaimedRewardAtLastTopup = {
	azeroReward: (string | number | BN),
	inwReward: (string | number | BN)
}
