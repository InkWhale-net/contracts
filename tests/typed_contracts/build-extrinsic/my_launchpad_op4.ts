...
export default class Methods {
	...
	*/
	"getAvailableAmount" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "launchpadContractTrait::getAvailableAmount", [phaseId], __options);
	}
	...
	*/
	"setCapAmount" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "launchpadContractTrait::setCapAmount", [phaseId, capAmount], __options);
	}
	...
	*/
	"getCapAmount" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "launchpadContractTrait::getCapAmount", [phaseId], __options);
	}
