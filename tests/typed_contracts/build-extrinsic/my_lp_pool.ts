...
export default class Methods {
	...
	*/
	"initialize" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "initialize", [walContract, lpContractAddress, psp22ContractAddress, multiplier, duration, startTime, unstakeFee], __options);
	}
