	...
	*/
	"initialize" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "initialize", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "lp_pool_generator");
	...
	*/
	"newPool" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "newPool", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "lp_pool_generator");
		}, [contractOwner, lpContractAddress, psp22ContractAddress, multiplier, duration, startTime], __options);
	}
