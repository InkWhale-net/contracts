...
import ABI from '../../artifacts/lp_pool_generator.json';
import QueryMethods from '../query/lp_pool_generator';
import BuildExtrinsicMethods from '../build-extrinsic/lp_pool_generator';
import TxSignAndSendMethods from '../tx-sign-and-send/lp_pool_generator';
import MixedMethods from '../mixed-methods/lp_pool_generator';
import EventsClass from '../events/lp_pool_generator';
