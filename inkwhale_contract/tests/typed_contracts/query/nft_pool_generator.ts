...
export default class Methods {
	...
	*/
	"newPool" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "newPool", [contractOwner, psp34ContractAddress, psp22ContractAddress, multiplier, duration, startTime], __options , (result) => { return handleReturnType(result, getTypeDescription(15, 'nft_pool_generator')); });
	}
	...
	*/
	"renounceOwnership" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "ownable::renounceOwnership", [], __options , (result) => { return handleReturnType(result, getTypeDescription(20, 'nft_pool_generator')); });
	}
	...
	*/
	"transferOwnership" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "ownable::transferOwnership", [newOwner], __options , (result) => { return handleReturnType(result, getTypeDescription(20, 'nft_pool_generator')); });
	}
	...
	*/
	"setPoolHash" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "genericPoolGeneratorTrait::setPoolHash", [poolHash], __options , (result) => { return handleReturnType(result, getTypeDescription(15, 'nft_pool_generator')); });
	}
	...
	*/
	"setWalContract" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "genericPoolGeneratorTrait::setWalContract", [walContract], __options , (result) => { return handleReturnType(result, getTypeDescription(15, 'nft_pool_generator')); });
	}
	...
	*/
	"setCreationFee" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "genericPoolGeneratorTrait::setCreationFee", [creationFee], __options , (result) => { return handleReturnType(result, getTypeDescription(15, 'nft_pool_generator')); });
	}
	...
	*/
	"setUnstakeFee" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "genericPoolGeneratorTrait::setUnstakeFee", [unstakeFee], __options , (result) => { return handleReturnType(result, getTypeDescription(15, 'nft_pool_generator')); });
	}
	...
	*/
	"withdrawFee" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "genericPoolGeneratorTrait::withdrawFee", [value], __options , (result) => { return handleReturnType(result, getTypeDescription(15, 'nft_pool_generator')); });
	}
	...
	*/
	"withdrawWal" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "genericPoolGeneratorTrait::withdrawWal", [value], __options , (result) => { return handleReturnType(result, getTypeDescription(15, 'nft_pool_generator')); });
	}
