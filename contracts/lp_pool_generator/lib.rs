...
pub mod lp_pool_generator {
    ...
    impl LPPoolGenerator {
        ...
        pub fn new_pool(
            ...
            let contract = MyLPPoolRef::new(contract_owner, self.manager.wal_contract, lp_contract_address, psp22_contract_address, multiplier, duration, start_time, self.manager.unstake_fee)
                .endowment(0)
